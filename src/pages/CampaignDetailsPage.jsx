      ...
      try {
        ...
        setTimeout(() => {
          setCampaign({
            ...
            description: "Your donation is needed for victims of flooding in Juba. The recent floods have displaced thousands of families who now need shelter, food, and medical supplies.",
            ...
            backers: 230,
            updates: [
              { date: "2025-03-15", content: "First shipment of supplies has reached affected areas" },
              { date: "2025-03-10", content: "Emergency response team deployed to assess needs" }
            ],
            organizer: {
          ...
          <div className="campaign-main">
            ...
            <div className="campaign-organizer">
              <div className="organizer-info">
                <img src={campaign.organizer.image || "/placeholder.svg"} alt={campaign.organizer.name} />
                <div>
                  <p>Organized by</p>
            ...
            <div className="donation-card">
              <div className="progress-container">
                <div className="progress-stats">
                  <div className="raised-amount">${campaign.raised.toLocaleString()}</div>
                  <div className="goal-text">raised of ${campaign.goal.toLocaleString()} goal</div>
                </div>
